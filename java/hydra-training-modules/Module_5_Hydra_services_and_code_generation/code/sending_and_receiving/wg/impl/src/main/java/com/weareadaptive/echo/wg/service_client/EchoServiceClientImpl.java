...
public class EchoServiceClientImpl implements EchoServiceClient
{
    ...
    {
        LOGGER.info("Received EchoResponse from echoWithReply: ").append(echoResponse.message()).log();
    }

    @Override
    public void onEchoRespondManyTimesResponse(final UniqueId correlationId, final EchoResponse echoResponse)
    {
        LOGGER.info("Received EchoResponse from echoRespondManyTimes: ").append(echoResponse.message()).log();
    }
    ...
    {
        LOGGER.info("Received Echo from echoToEverybody: ").append(echo.message()).log();
    }
}

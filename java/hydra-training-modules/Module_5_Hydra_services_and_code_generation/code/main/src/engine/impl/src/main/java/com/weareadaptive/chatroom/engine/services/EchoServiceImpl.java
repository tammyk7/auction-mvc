...
public class EchoServiceImpl implements EchoService
{
    ...
    {
        LOGGER.info("Received following Echo message from echoFireAndForgetWithMessage: ".concat(echo.message().toString())).log();
    }

    @Override
    public void echoWithReply(final UniqueId correlationId, final EchoRequest echoRequest)
    {
        LOGGER.info("Received following Echo message from echoWithReply: ".concat(echoRequest.message().toString())).log();

...
public final class OrderEgressDecoder
{
    ...
    private final OrderEgressDecoder parentMessage = this;
    ...
    public OrderEgressDecoder wrap(
    ...
    public OrderEgressDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public OrderEgressDecoder sbeRewind()
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        builder.append("[OrderEgress](sbeTemplateId=");
    ...
    public OrderEgressDecoder sbeSkip()
    {
        sbeRewind();

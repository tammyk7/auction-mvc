...
/**
 * Egress for a order placement
 */
@SuppressWarnings("all")
public final class OrderEgressEncoder
{
    ...
    private final OrderEgressEncoder parentMessage = this;
    ...
    public OrderEgressEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public OrderEgressEncoder wrapAndApplyHeader(
    ...
    public OrderEgressEncoder orderid(final long value)
    {
        buffer.putLong(offset + 0, value, java.nio.ByteOrder.LITTLE_ENDIAN);
        return this;
    }

    public OrderEgressEncoder status(final byte value)
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        final OrderEgressDecoder decoder = new OrderEgressDecoder();

...
public class BufferUtils
{
    ...
    public static EncodeResult I_CLEAR_Encoder(final long correlationId)
    {
        final ExpandableArrayBuffer buffer = new ExpandableArrayBuffer(128);
    ...
    public static EncodeResult I_RESET_Encoder(final long correlationId)
    {
        final ExpandableArrayBuffer buffer = new ExpandableArrayBuffer(128);
    ...
    public static EncodeResult E_CLEAR_Encoder(final long correlationId)
    {
        final ExpandableArrayBuffer buffer = new ExpandableArrayBuffer(128);
    ...
    public static EncodeResult E_RESET_Encoder(final long correlationId)
    {
        final ExpandableArrayBuffer buffer = new ExpandableArrayBuffer(128);

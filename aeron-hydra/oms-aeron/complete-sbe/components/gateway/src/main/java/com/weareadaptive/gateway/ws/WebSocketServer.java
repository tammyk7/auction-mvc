...
public class WebSocketServer extends AbstractVerticle
{
    ...
    private void wsHandler(final ServerWebSocket ws)
    {
        ws.handler(buffer ->
        {
            ...
            clientEgressListener.addWSSession(correlationId, ws);
            switch (command)
            {
    ...
    private void wsPlaceOrder(final JsonObject payload)
    {
        ...
        clientIngressSender.placeOrder(correlationId, price, size, side);
    }
    ...
    private void wsCancelOrder(final JsonObject payload)
    {
        ...
        clientIngressSender.cancelOrder(correlationId, orderId);
    }
    ...
    {
        clientIngressSender.clearOrderbook(correlationId);
    }
    ...
    {
        clientIngressSender.resetOrderbook(correlationId);
    }
}
